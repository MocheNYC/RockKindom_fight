...
```powershell
.\.venv\Scripts\python.exe .\pettingzoo_demo\train_rocofight_maskable_ppo.py --total-timesteps 256 --eval-every 128 --eval-episodes 2 --n-steps 64 --batch-size 32 --max-turns 40 --output-dir .\pettingzoo_demo\outputs\rocofight_maskppo_smoke
```
